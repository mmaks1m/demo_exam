...
class User(Base):
    ...
    password = Column(String(100))  # Обратите внимание: называется 'password', а не 'password_hash'
...
class Product(Base):
    ...
    # В вашей БД нет столбца 'id', используется 'article' как идентификатор
    article = Column(String(20), primary_key=True, index=True)
    name = Column(String(100))
    unit = Column(String(20))
    price = Column(Numeric(10, 2))  # NUMERIC в PostgreSQL
